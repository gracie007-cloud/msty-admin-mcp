...
def safe_query_table(db_path: str, table_name: str, limit: int = 100, where_clause: str = None, params: tuple = ()) -> list:
    """
...
def safe_count_table(db_path: str, table_name: str, where_clause: str = None, params: tuple = ()) -> int:
